  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "red-ferrari": "#EF4444",
        "red-ferrari-dim": "#B91C1C",
        "cyan-electric": "#06B6D4",
        "cyan-electric-dim": "#0E7490",
        "green-telemetry": "#10B981",
        "green-telemetry-dim": "#047857",
      ...
      boxShadow: {
        ...
        "glow-red-sm": "0 0 12px rgba(239, 68, 68, 0.28)",
        "glow-red": "0 0 20px rgba(239, 68, 68, 0.38)",
        "glow-red-lg": "0 0 32px rgba(239, 68, 68, 0.48)",

        // Cyan glows (focus, active)
        "glow-cyan-sm": "0 0 12px rgba(6, 182, 212, 0.22)",
        "glow-cyan": "0 0 20px rgba(6, 182, 212, 0.32)",
        "glow-cyan-lg": "0 0 32px rgba(6, 182, 212, 0.42)",

        // Green glows (telemetry)
        "glow-green-sm": "0 0 12px rgba(16, 185, 129, 0.22)",
        "glow-green": "0 0 20px rgba(16, 185, 129, 0.32)",
        "glow-green-lg": "0 0 32px rgba(16, 185, 129, 0.42)",

        // Combined (shadow + glow)
        "card-red":
          "0 4px 12px rgba(0, 0, 0, 0.3), 0 0 16px rgba(239, 68, 68, 0.22)",
        "card-cyan":
          "0 4px 12px rgba(0, 0, 0, 0.3), 0 0 16px rgba(6, 182, 212, 0.2)",
        "card-green":
          "0 4px 12px rgba(0, 0, 0, 0.3), 0 0 16px rgba(16, 185, 129, 0.2)",
      },

      textShadow: {
        "glow-red": "0 0 8px rgba(239, 68, 68, 0.22)",
        "glow-cyan": "0 0 8px rgba(6, 182, 212, 0.2)",
        "glow-green": "0 0 8px rgba(16, 185, 129, 0.2)",
      },
      ...
      keyframes: {
        ...
        glowPulse: {
          "0%, 100%": {
            boxShadow:
              "0 0 16px rgba(220, 20, 60, 0.28), 0 0 48px rgba(220, 20, 60, 0.12)",
          },
          "50%": {
            boxShadow:
              "0 0 28px rgba(220, 20, 60, 0.45), 0 0 80px rgba(220, 20, 60, 0.22)",
          },
        },
        hoverLift: {
        ...
        metricUpdate: {
          "0%": { color: "#06B6D4", transform: "scale(1.1)" },
        ...
        pulseGlow: {
          "0%, 100%": {
            boxShadow:
              "0 0 16px rgba(255,30,30,0.28), 0 0 48px rgba(255,30,30,0.12)",
          },
          "50%": {
            boxShadow:
              "0 0 28px rgba(255,30,30,0.45), 0 0 80px rgba(255,30,30,0.22)",
          },
        },
        scanLine: {
        ...
        pulseDot: {
          "0%, 100%": {
            opacity: "1",
            boxShadow: "0 0 0 0 rgba(255,30,30,0.45)",
          },
