  ...
  return (
    <nav
      className={cn(
        ...
        scrolled
          ? "shadow-[0_1px_0_rgba(0,0,0,0.06)] dark:shadow-[0_1px_0_rgba(255,255,255,0.06)]"
          : "",
      )}
    >
      <div
      ...
      >
        <div className="max-w-[1500px] mx-auto px-6 flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            ...
            <span className="hidden lg:inline-block font-mono text-[10px] tracking-[0.15em] text-muted-foreground uppercase border-l border-border pl-2.5">
              Race OS
            </span>
          </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex items-center gap-1.5 px-3 h-8 rounded-md bg-accent border border-[rgba(6,182,212,0.22)]">
              <span className="w-1.5 h-1.5 rounded-full bg-green-telemetry" />
              <span className="font-rajdhani text-[11px] font-semibold tracking-[0.12em] text-cyan-electric uppercase">
                Live
              </span>
            </div>
            <Link
